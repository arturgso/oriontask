...
const Styles = {
  ...
  addButton: 'px-3 py-1 bg-gray-800 text-white text-sm hover:bg-gray-700 flex items-center gap-1',
  taskList: 'space-y-2',
  ...
  formActions: 'flex gap-2 mt-4',
  cancelButton: 'flex-1 px-3 py-2 bg-gray-300 hover:bg-gray-400',
  submitButton: 'flex-1 px-3 py-2 bg-gray-800 text-white hover:bg-gray-700 disabled:opacity-50',
};
