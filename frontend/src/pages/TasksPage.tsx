...
const Styles = {
  ...
  sectionHeader: 'flex flex-col md:flex-row justify-between items-start md:items-center mb-3 border-b pb-2 gap-2',
  sectionTitle: 'text-sm md:text-base font-bold',
  addButton: 'px-3 md:px-4 py-2 bg-gray-800 text-white text-xs md:text-sm hover:bg-gray-700 flex items-center gap-2 rounded font-semibold transition-colors whitespace-nowrap',
  taskList: 'space-y-2 md:space-y-3',
  empty: 'text-center text-gray-500 py-4 text-xs md:text-sm',
  modal: 'fixed inset-0 bg-black/30 flex items-center justify-center p-3 md:p-4 z-50',
  form: 'bg-white border border-gray-400 p-4 md:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto',
  ...
  select: 'w-full px-2 py-1.5 md:py-2 border border-gray-400 focus:outline-none focus:border-gray-600 text-sm',
  formActions: 'flex gap-2 md:gap-3 mt-4 md:mt-5',
  cancelButton: 'flex-1 px-3 md:px-4 py-2 md:py-3 bg-gray-300 hover:bg-gray-400 font-semibold text-sm transition-colors',
  submitButton: 'flex-1 px-3 md:px-4 py-2 md:py-3 bg-gray-800 text-white hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed font-semibold text-sm transition-colors',
};
