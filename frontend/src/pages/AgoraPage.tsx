...
const Styles = {
  ...
  icon: 'text-yellow-500 w-5 md:w-6 h-5 md:h-6',
  title: 'text-base md:text-lg font-bold',
  subtitle: 'text-xs md:text-sm text-gray-600 mb-3',
  counter: 'bg-gray-100 border border-gray-300 p-2 md:p-3 mb-3 md:mb-4 rounded',
  counterText: 'text-xs md:text-sm font-semibold',
  taskList: 'space-y-2 md:space-y-3',
  showMore: 'mt-3 px-3 md:px-4 py-2 border border-gray-300 hover:bg-gray-100 text-xs md:text-sm rounded transition-colors',
  empty: 'text-center py-6 md:py-8 text-gray-500',
  emptyText: 'text-xs md:text-sm font-semibold mb-1',
  emptyHint: 'text-xs text-gray-400',
  loading: 'text-center py-6 md:py-8 text-gray-500 text-sm',
};
