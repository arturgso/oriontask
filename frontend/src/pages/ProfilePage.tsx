...
const Styles = {
  ...
  back: 'inline-flex items-center gap-2 text-text-muted text-sm hover:text-text-primary transition',
  heading: 'space-y-1',
  title: 'text-3xl font-semibold text-text-primary',
  ...
  heroIcon: 'h-16 w-16 rounded-2xl border border-surface bg-card flex items-center justify-center text-text-muted',
  heroMeta: 'flex-1',
  heroLabel: 'text-xs uppercase tracking-wide text-text-muted',
  heroName: 'text-2xl font-semibold text-text-primary',
  heroEmail: 'text-sm text-text-muted',
  sectionHeading: 'text-xs font-semibold text-text-muted uppercase tracking-wide flex items-center gap-2',
  infoList: 'space-y-4',
  infoItem: 'flex items-start gap-3',
  infoIcon: 'h-11 w-11 rounded-xl bg-card border border-surface flex items-center justify-center text-text-muted',
  infoCopy: 'space-y-1',
  infoLabel: 'text-xs text-text-muted uppercase tracking-wide',
  infoValue: 'text-base text-text-primary font-medium',
  buttonRow: 'flex flex-wrap gap-3 pt-2',
  ghostButton: 'px-4 py-2.5 rounded-xl border border-surface text-text-primary hover:bg-base/60 transition disabled:opacity-60',
  ...
  input: 'w-full px-4 py-3 rounded-xl bg-base border border-surface text-text-primary focus:border-accent focus:ring-2 focus:ring-accent/30 outline-none placeholder:text-text-muted',
  togglePassword: 'flex items-center justify-center text-text-muted hover:text-text-primary transition',
  helper: 'text-xs text-text-muted',
  loading: 'text-text-muted text-center w-full py-10',
  meta: 'text-xs text-text-muted border-t border-surface pt-4',
};
