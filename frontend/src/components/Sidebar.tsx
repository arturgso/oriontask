...
const Styles = {
  ...
  dharmasSection: 'mb-8',
  sectionTitle: 'text-xs text-text-muted uppercase tracking-wider mb-3 font-semibold',
  dharmaList: 'flex flex-col gap-2',
  dharmaItem: 'cursor-pointer hover:bg-surface/50 rounded-md px-2 py-1.5 flex items-center gap-2 text-text-primary text-sm transition-colors',
  dharmaColor: 'h-2.5 w-2.5 rounded-full flex-shrink-0',
  manageButton: 'flex items-center gap-2 mt-3 text-sm text-text-muted hover:text-text-primary transition-colors px-2 py-1.5',
  navList: 'flex flex-col gap-1',
  navButton: 'flex items-center gap-3 px-2 py-2 text-sm text-text-primary hover:bg-surface/50 rounded-md transition-colors',
  footer: 'border-t border-surface p-6 flex flex-col gap-1',
  footerButton: 'flex items-center gap-3 px-2 py-2 text-sm text-text-muted hover:text-text-primary hover:bg-surface/50 rounded-md transition-colors',
};
